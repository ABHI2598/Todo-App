...
const Todos = () => {
    ...
    return(
        ...
        <div className="absolute top-[24%] left-[30%] right-[35%]">
            <input type="text" className="py-3 px-4 block w-full border-gray-200 rounded-md text-sm focus:border-blue-500 focus:ring-blue-500 dark:bg-slate-900 dark:border-gray-700 dark:text-gray-400" placeholder="Create a new todo..." value={text} onChange={handleChange}/>
        </div>
